...
describe("Redeem of releasable tokens after creating a stake", function () {
    ...
    describe('Reverts', async () => {
        ...
        it("Owner should not be able to (tranfer/mint)_and_lock with amount equal to 0", async () => {
            ...
            await expect(Web3MusicNativeToken.connect(owner).transfer_and_lock(owner.address, addr1.address, 0, await getTimestamp(), 3600))
        ...
        it("Only owner should be able to (tranfer/mint)_and_lock", async () => {
            ...
            await expect(Web3MusicNativeToken.connect(addr1).transfer_and_lock(owner.address, addr1.address, 0, await getTimestamp(), 3600))
